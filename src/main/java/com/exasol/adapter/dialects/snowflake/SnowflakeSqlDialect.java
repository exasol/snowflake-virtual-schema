...
/**
 * This class implements the Snowflake dialect.
 */
public class SnowflakeSqlDialect extends AbstractSqlDialect {
    ...
    private static final Set<ScalarFunctionCapability> DISABLED_SCALAR_FUNCTION = Set.of(
            ...
            ROUND, // Snowflake rounds `0.5` down while Exasol rounds it up
            SECOND, // It presents precision issues
            COLOGNE_PHONETIC, // No Snowflake equivalent
    ...
    static final String DATABASE_NAME_PROPERTY = "DATABASE_NAME";
    static final String ACCOUNT_NAME_PROPERTY = "ACCOUNT_NAME";
    ...
    public SqlGenerator getSqlGenerator(final SqlGenerationContext context) {
        return new SnowflakeSqlGenerationVisitor(this, context);
    }
